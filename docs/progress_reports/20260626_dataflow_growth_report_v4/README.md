...
- generated_at: `2026-06-26T21:44:40`
- batch_root: `D:\MoonStack\experiments\moon_rock_stack\batch_runs`
- report_dir: `D:\MoonStack\experiments\moon_rock_stack\docs\progress_reports\20260626_dataflow_growth_report_v4`
...
- 观察性统计中 strict success 差值最大的判别标准是 `PoseRiskNet`，enabled-disabled = `0.067`。
- 最新可读模型指标来自 `20260626_clean_wall34_pose_risk_net_v1/pose_risk_net`，训练行数 `121679`，test F1 `0.801`。
...
| 阶段 | 名称 | 输入/来源 | 输出规模 | 用途 |
|---|---|---|---:|---|
| dataset | `20260622_autonomous_wall_flywheel_master_v2_c20_flywheel_3to4_learning_dataset` | `raw experiment logs` | placement=807, candidate=22167, assignment=6498 | training / analysis |
...
| model | `20260626_low_release_wall_master_v1_c03_flywheel_3to4_stone_slot_net/stone_fit_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_low_release_wall_master_v1_c03_flywheel_3to4_learning_dataset` | rows=6498, epochs=80 | ranking / risk / critic |
...
| model | `20260626_low_release_wall_master_v1_c04_flywheel_3to4_stone_slot_net/stone_fit_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_low_release_wall_master_v1_c04_flywheel_3to4_learning_dataset` | rows=6498, epochs=80 | ranking / risk / critic |
...
| model | `20260626_policy_replacement_stone_slot_net_v1/stone_fit_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_policy_replacement_dataset_v1` | rows=28075, epochs=180 | ranking / risk / critic |
| model | `20260626_policy_replacement_pose_risk_net_v1/pose_risk_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_policy_replacement_dataset_v1` | rows=141988, epochs=160 | ranking / risk / critic |
| model | `20260626_clean_wall34_stone_slot_net_v1/stone_fit_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_clean_policy_wall34_dataset_v1` | rows=27322, epochs=220 | ranking / risk / critic |
| model | `20260626_clean_wall34_pose_risk_net_v1/pose_risk_net` | `D:\MoonStack\experiments\moon_rock_stack\batch_runs\20260626_clean_policy_wall34_dataset_v1` | rows=121679, epochs=180 | ranking / risk / critic |
...
|---|---:|---:|---:|---:|---:|---|
| `20260622_autonomous_wall_flywheel_master_v2_c21_flywheel_3to4_stone_slot_net/stone_fit_net` | 6498 | 80 | 0.211 | 0.382 | 0.559 | `20260622_autonomous_wall_flywheel_master_v2_c21_flywheel_3to4_learning_dataset` |
...
| `20260622_autonomous_wall_flywheel_master_v2_c23_flywheel_3to4_stone_slot_net/stone_fit_net` | 6498 | 80 | 0.133 | 0.105 | 0.289 | `20260622_autonomous_wall_flywheel_master_v2_c23_flywheel_3to4_learning_dataset` |
...
| `20260622_autonomous_wall_flywheel_master_v2_c24_flywheel_3to4_stone_slot_net/stone_fit_net` | 6498 | 80 | 0.125 | 0.058 | 0.250 | `20260622_autonomous_wall_flywheel_master_v2_c24_flywheel_3to4_learning_dataset` |
...
| `20260626_low_release_wall_master_v1_c03_flywheel_3to4_stone_slot_net/stone_fit_net` | 6498 | 80 | 0.118 | 0.083 | 0.278 | `20260626_low_release_wall_master_v1_c03_flywheel_3to4_learning_dataset` |
...
| `20260626_low_release_wall_master_v1_c04_flywheel_3to4_stone_slot_net/stone_fit_net` | 6498 | 80 | 0.205 | 0.382 | 0.559 | `20260626_low_release_wall_master_v1_c04_flywheel_3to4_learning_dataset` |
...
| `20260626_policy_replacement_stone_slot_net_v1/stone_fit_net` | 28075 | 180 | 0.141 | 0.153 | 0.386 | `20260626_policy_replacement_dataset_v1` |
| `20260626_policy_replacement_pose_risk_net_v1/pose_risk_net` | 141988 | 160 | 0.817 | 0.644 | 0.927 | `20260626_policy_replacement_dataset_v1` |
| `20260626_clean_wall34_stone_slot_net_v1/stone_fit_net` | 27322 | 220 | 0.127 | 0.103 | 0.284 | `20260626_clean_policy_wall34_dataset_v1` |
| `20260626_clean_wall34_pose_risk_net_v1/pose_risk_net` | 121679 | 180 | 0.801 | 0.625 | 0.890 | `20260626_clean_policy_wall34_dataset_v1` |
